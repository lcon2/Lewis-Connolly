...
<a href="{{ '/assets/images/geneology2.png' | relative_url }}" data-post-lightbox-trigger data-lightbox-src="{{ '/assets/images/geneology2.png' | relative_url }}" data-lightbox-alt="Genealogy chart tracing the Connolly and McCarthy family line toward Terrence Connolly." data-lightbox-caption="Genealogy chart tracing the Connolly and McCarthy family line toward Terrence Connolly."><img class="post-float-image post-float-image--genealogy" src="{{ '/assets/images/geneology2.png' | relative_url }}" alt="Genealogy chart tracing the Connolly and McCarthy family line toward Terrence Connolly." loading="lazy" decoding="async"></a>
