...
ai_summary: "The story of Abraham is the archetypal standard for the first and the second half of life. In the first half he is not called Abraham, but Abram, and he’s living not in Israel, but in a city called ‘Ur’, which (going back to last week) was a city in the orbit of Babel (in modern day Iraq). Amen. There..."
---
