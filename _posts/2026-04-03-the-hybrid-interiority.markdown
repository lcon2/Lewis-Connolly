---
layout: post
title: "The Hybrid Interiority"
seo_title: "The Hybrid Interiority: On AI and the Colonisation of the Inner Life"
date: 2026-04-03
...
categories:
  ...
  - Technology
  - Meaning
description: "A Jungian reading of brain-computer interfaces, Neuralink, and AI in the inner life. The essay asks what happens when machine content no longer arrives as something external, but begins to appear within consciousness in the guise of thought itself, raising questions about ego, Self, symbol-formation, psychic authority, and the fate of a genuinely human interior life."
tagline: "When the machine stops acting like a tool and starts sounding like the mind."
og_image: /assets/images/hybrid-interiority.png
og_image_width: 1536
og_image_height: 1024
image_alt: "Portrait image for The Hybrid Interiority, on AI and the inner life."
read_next:
...
<img src="{{ '/assets/images/hybrid-interiority.png' | relative_url }}" alt="The Hybrid Interiority" style="display: block; margin: 20px auto; max-width: 600px; height: auto;">
...
I am going to use a Jungian framework to think about that threshold. Not because Jung offers a scientifically final account of the mind, which I do not think he does, but because he remains unusually good at describing what inner life feels like from the inside. As a symbolic map of lived experience, analytical psychology still has real force.

For Jung, the ego is the centre of consciousness, while the Self is the totality of the psyche. We need to keep in mind that these terms are being used in a specifically Jungian sense: ordinary dictionary definitions will not do, which is why I am using *A Critical Dictionary of Jungian Analysis* by Andrew Samuels et al. as a reference.<img src="/assets/images/footnote/no1.png" alt="Footnote 1" style="width: 15px; height: 15px; margin: 0; padding: 0; position: relative; top: -7px; vertical-align: middle; display: inline; border: none;">
...
1. **Exogenous arrival:** AI content is experienced as an external object within the conscious field. This is akin to a “digital notification” or a voice in an earpiece. This is, broadly speaking, how all AI content is experienced presently.
2. **Endogenous surfacing:** AI content arises as if it were a native psychic event—a sudden intuition, a memory, or a pre-verbal urge.
...
<blockquote style="margin: 1.5em 0 1.5em 1.5em; padding-left: 1em; border-left: 3px solid #ccc; font-style: italic;">
Are ‘you’ the ego—that is to say, the executive centre of conscious experience—or are ‘you’ the totality of the psyche, which is to say the Self? Or is ‘you’ better understood as something more like a verb: the very process of moving toward greater integration, what Jung called individuation?<img src="/assets/images/footnote/no2.png" alt="Footnote 2" style="width: 15px; height: 15px; margin: 0; padding: 0; position: relative; top: -7px; vertical-align: middle; display: inline; border: none;">
</blockquote>
...
I can imagine that our culture may pull strongly in the other direction. Why preserve hesitation when one can have fluency? Why preserve uncertainty when one can have guidance? Why preserve inward struggle when one can have psychic optimisation? But it may be here in that hesitation, that uncertainty, and that struggle, that something distinctly human is formed. Not greatness. Not speed. Something slower and less flashy than that: character, or perhaps we could call it soul.
...
1. Samuels, Andrew, Bani Shorter, and Fred Plaut. *A Critical Dictionary of Jungian Analysis* (1986). London: Routledge & Kegan Paul.

2. Jung, C. G. *Two Essays on Analytical Psychology* (1966). Princeton, NJ: Princeton University Press.

3. Jung, C. G. *The Structure and Dynamics of the Psyche* (1972). Princeton, NJ: Princeton University Press.

4. Jung, C. G. *Aion: Researches into the Phenomenology of the Self* (1968). Princeton, NJ: Princeton University Press.
