...
<ol style="margin-left: 2.75em; margin-right: 0; padding-left: 1em; list-style-position: outside;">
<li style="margin-bottom: 0.65em;"><strong>Exogenous arrival:</strong> AI content is experienced as an external object within the conscious field. This is akin to a <em>digital notification</em> or a voice in an earpiece. This is, broadly speaking, how all AI content is experienced presently.</li>
...
<div style="margin: 1.35em 0 1.35em 2em; padding: 0; background: none; border: none;">
<p style="margin: 0; font-style: italic;">Are you the ego—that is to say, the executive centre of conscious experience—or are you the totality of the psyche, which is to say the Self? Or should <em>you</em> be understood as something more like a verb: the very process of moving toward greater integration, what Jung called individuation?<img src="/assets/images/footnote/no2.png" alt="Footnote 2" style="width: 15px; height: 15px; margin: 0; padding: 0; position: relative; top: -7px; vertical-align: middle; display: inline; border: none;"></p>
</div>
